...
(autothemer-deftheme
 ...
 ((default                                   (:foreground darktooth-light1 :background darktooth-dark0))
  (vertical-border                           (:foreground darktooth-dark2 :background darktooth-dark2))
  (cursor                                    (:background darktooth-light1))
