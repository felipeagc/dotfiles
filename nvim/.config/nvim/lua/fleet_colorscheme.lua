...
local theme = lush(function()
  return {
    ...
    Comment      { fg = hsl(palette.light_gray) }, -- any comment
    -- ColorColumn  { }, -- used for the columns set with 'colorcolumn'
    -- Conceal      { }, -- placeholder characters substituted for concealed text (see 'conceallevel')
    Cursor       { bg = Normal.fg, fg = hsl(palette.dark_gray) }, -- character under the cursor
    ...
    --
    DiagnosticError            { bg = Normal.bg.mix(hsl(palette.red_error), 10), fg = hsl(palette.red_error) } , -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
    DiagnosticWarn             { bg = Normal.bg.mix(hsl(palette.orange_accent), 10), fg = hsl(palette.orange_accent) } , -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
    ...
    DiagnosticHint             { bg = Normal.bg.mix(hsl(palette.blue), 10), fg = hsl(palette.blue) } , -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
